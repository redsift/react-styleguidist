	...
	function StateHolder() {
		...
		return (
			(_ret = ((_temp = ((_this = _possibleConstructorReturn(
				this,
				(_ref = StateHolder.__proto__ || Object.getPrototypeOf(StateHolder)).call.apply(
					_ref,
					[this].concat(args)
				)
			)),
			...
			(_this.setStateBinded = _this.setState.bind(_this)),
			_temp)),
...
var ReactExample = (function(_Component2) {
	...
	function ReactExample() {
		...
		return _possibleConstructorReturn(
			this,
			(ReactExample.__proto__ || Object.getPrototypeOf(ReactExample)).apply(this, arguments)
		);
	}
