...
export function TextRenderer(_ref2) {
	...
	var classNames = cx(
		...
		classes[color + 'Color'],
		((_cx = {}),
		_defineProperty(_cx, classes[semantic], semantic),
		_defineProperty(_cx, classes.isUnderlined, underlined),
		_cx)
	);

	return React.createElement(Tag, _extends({}, props, { className: classNames }), children);
}
